...
import { Newspaper, Copy, Check, Sparkles, Calendar, Clock, Share2 } from 'lucide-react';
import { INITIAL_RECAPS } from '../../data/demoData';
    ...
    <div id="recaps-view" className="max-w-4xl mx-auto space-y-6 pb-16 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs">
        ...
        <p className="text-xs text-slate-700">
          Curated executive summaries synthesized from verified programme decisions and milestones.
        </p>
      </div>

      {/* Recaps Feed */}
      <div className="space-y-4">
        {INITIAL_RECAPS.map((recap) => {
